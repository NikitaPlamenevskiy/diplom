...
import {GITHUB_API} from "./js/constants/constants";
...
/*блок карточек*/
const cardCommitList = new CommitsCardList(apiGitHub,document.querySelector(".glider"), commitCard);
