...
export default class NewsCardList {
	constructor(container, cardElement) {
		...
		this.count = 0;
		this.total = 0;
        localStorage.getItem("total",this.total);
	}
	...
	renderFirstCards(cards, word) {
        ...
        console.log("Работаю",localStorage.getItem("total"));
	}
	render() {
		...
		this.total += 3;
        dataStorage.setItem("total",this.total);
        console.log("Работаю",dataStorage.getItem("total"));
	}
	postCardRender() {
      if (dataStorage.getItem("total") !== undefined){
